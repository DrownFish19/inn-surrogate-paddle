...
def load_data():
    Train_hdf5_file = '{}/Config_2_train_obs_{}pc_3D.hdf5'.format(args.data_path, args.pc)
    ...
    Test_hdf5_file = '{}/Config_2_test_obs_{}pc_3D.hdf5'.format(args.data_path, args.pc)
    ...
    Sample_hdf5_file = '{}/Config_2_sample_obs_{}pc_3D.hdf5'.format(args.data_path, args.pc)
