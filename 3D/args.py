...
parser.add_argument('--cond_size', type=int, default=64, help='Conditioning dimension')
parser.add_argument('--hidden_layer_channel', type=int, default=48, help='number of channels for the hidden layer')
# Block-2
parser.add_argument('--input_dimension1_r', type=list, default=[(2, 4, 32, 32)], help='Input dimension block-2 in CXHXW')
parser.add_argument('--cond_size1', type=int, default=64, help='Conditioning dimension in CXHXW')
parser.add_argument('--hidden_layer_channel1', type=int, default=48, help='number of channels for the hidden layer')
parser.add_argument('--input_dimension1', type=int, default=4, help='coupling block-2')
parser.add_argument('--input_dimension12', type=int, default=4, help='coupling block-2')
parser.add_argument('--permute_a1', type=int, default=4, help='permutation for the invertible block-2')
# Block-3
parser.add_argument('--input_dimension2_r', type=list, default=[(4, 4, 16, 16)], help='Input dimension block-3 in CXHXW')
parser.add_argument('--cond_size2', type=int, default=48, help='Conditioning dimension in CXHXW')
...
parser.add_argument('--input_dimension22', type=int, default=4, help='dinvertible block-3')
parser.add_argument('--permute_a2', type=int, default=8, help='permutation for the invertible block-3')
# training
parser.add_argument('--epochs', type=int, default=202, help='number of epochs to train (default: 200)')
parser.add_argument('--lr', type=float, default=0.0008, help='learnign rate')
parser.add_argument('--weight_decay', type=float, default=8e-8, help="weight decay")
...
# Block-4
parser.add_argument('--cond_size3', type=int, default=4096, help='Conditioning dimension in (D,)')
parser.add_argument('--hidden_layer3', type=int, default=8192, help='number of channels for the hidden layer')
parser.add_argument('--input_dimension3', type=int, default=4096, help='invertible block-4')
parser.add_argument('--input_dimension32', type=int, default=1, help='dinvertible block-4')
parser.add_argument('--permute_a3', type=int, default=4096, help='permutation for the invertible block-4')
# for run different datasets
parser.add_argument('--data_path', type=str, default='../data/3D_problem_dataset')  # 数据位置
...
parser.add_argument('--results_path', type=str, default='results-3D')  # 结果保存位置
