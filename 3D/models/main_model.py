...
class main_file(nn.Layer):
    ...
    def forward(self, x, c1, c2, c3, c4, sample_the_data=False, forward=False, jac=False):
        if forward == True:
            ...
            final_out = paddle.concat((flat_output1, flat_output2, out_all), axis=1)
            ...
            # combine the data
            combine_out2_out3 = paddle.concat((out3_unflat, out2_unflat), axis=1)
            # =========================================
            # permute the data
            ...
            combine_out6_out1 = paddle.concat((out_6, out1_unflat), axis=1)
            # =============================
            # permute
